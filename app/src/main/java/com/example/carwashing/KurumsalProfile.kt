...
class KurumsalProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        editProfileButton.setOnClickListener {
            ...
            val intent = Intent(context, KurumsalProfileInfo::class.java)
            ...
            firestore.collection("users")
                ...
                .addOnSuccessListener { document ->
                    if (document != null && document.exists()) {
                        ...
                        Toast.makeText(context, "CompanyName verisi alınamadı!", Toast.LENGTH_SHORT).show()
                    }
                }
